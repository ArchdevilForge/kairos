"""Runtime configuration management for kairos."""
...
from kairos.utils.config_io import write_config
from kairos.utils.config_validator import ValidationRule, config_validator
...
class ConfigManager:
    ...
    def _normalize(self, config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if isinstance(notification_symbols, str) and notification_symbols.strip().lower() == "default":
            ...
            from kairos.utils.default_symbols import get_default_symbols
