...
from ..trades.executor import TradeExecutor, Order, OrderSide, OrderType, PositionSide
from ..trades.position import PositionManager, Position
...
class FundingArbitrage:
    ...
    def __init__(
        ...
        self.logger = logging.getLogger("pwatch.arbitrage.arb")
        self.config = config
