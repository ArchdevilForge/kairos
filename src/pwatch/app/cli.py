...
def main():
    """Main entry point."""
    parser = argparse.ArgumentParser(prog="pwatch", description="Cryptocurrency futures price monitor & trading system")
    ...
    # Trading commands
    from pwatch.app.trade_cli import register_trading_commands, get_trading_commands
